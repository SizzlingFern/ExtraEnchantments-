...
public class ChestplateInformation extends Menu {

	@Getter
	private final static ChestplateInformation instance = new ChestplateInformation();

	private ChestplateInformation() {
...
//######################################################################################################################
		...
		lore1.add("");
		lore1.add(ChatColor.GRAY + "When equiped you can make enemies glow");
		lore1.add(ChatColor.GRAY + "by hitting them. This glow will be removed");
		lore1.add(ChatColor.GRAY + "when enemy or entity is killed");

		shard_meta1.setLore(lore1);
		shard_meta1.setDisplayName(ChatColor.DARK_PURPLE + "" + ChatColor.BOLD + "Glow");
